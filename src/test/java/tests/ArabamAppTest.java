...
public class ArabamAppTest {
    ...
    public void arabamTest() throws InterruptedException {
        ...
        action.press(PointOption.point(514,2023))
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(500)))
                .moveTo(PointOption.point(503,322)).release().perform();

        Thread.sleep(2000);

        driver.findElementByXPath("//*[@text='Volkswagen']").click();
        /*
        action.press(PointOption.point(503,322))
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(500)))
                .moveTo(PointOption.point(514,2023)).release().perform();
       ===> Eger ki daha onceden kaydirma islemi gerceklestirmissek tam tersi hareketini gerceklestirmek icin
